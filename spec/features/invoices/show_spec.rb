  ...
  describe 'as a merchant' do
    describe 'when I visit my merchant invoices show page (/merchants/:merchant_id/invoices/:id)' do
      ...
      it 'displays the total revenue generated from all of the merchant items on the invoice' do
        ...
        expect(page).to have_content("Total pre-discount revenue for invoice ##{@invoice_6.id}: $8800")
      end
      ...
      in the calculation' do
        ...
        expect(page).to have_content("Total revenue for invoice ##{@invoice_6.id} with applicable bulk discounts: $6280") # $5880 snorkle 
      end
